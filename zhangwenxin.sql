...
CREATE DATABASE IF NOT EXISTS zhangwenxin;
USE zhangwenxin;
...
INSERT INTO `menus` (`id`,`name`,`typeid`,`burden`,`brief`,`price`,`sums`,`price1`,`sums1`,`imgpath`) VALUES 
 ...
 (20,'东北大学',2,'学生，老师','暂无',20,0,18,1,'img/NEU.gif');
...
INSERT INTO `notice` (`id`,`name`,`content`,`times`) VALUES 
 (6,'新增菜单《糖醋排骨》','糖醋排骨超级好吃。再挑食的小朋友都无法拒绝酸甜的口味，吃光排骨，再用糖醋汁拌米饭，今天的饭量见长。','2024-04-28 13:49:40'),
 (7,'本店特色《咸菜肉饭》','记得小时候每每妈妈做咸肉菜饭，我都要吃上二大碗，那个香啊那个好吃啊，真的不知道怎样来形容。吃过的朋友，大家都懂的!','2024-04-28 13:53:39');
...
INSERT INTO `orders` (`id`,`userid`,`menuid`,`menusum`,`times`,`delivery`) VALUES 
 (16,2,12,2,'2024-04-26 13:16:28',1),
 (17,1,14,1,'2024-04-26 13:23:30',1),
 (19,4,15,2,'2024-04-26 23:26:20',1),
 (23,4,14,1,'2024-04-27 00:35:09',1),
 (24,4,17,1,'2024-04-27 00:35:09',1),
 (25,2,15,1,'2024-04-27 20:14:23',1),
 (27,2,18,1,'2024-04-27 20:31:56',1),
 (28,2,19,1,'2024-04-27 20:31:56',0);
